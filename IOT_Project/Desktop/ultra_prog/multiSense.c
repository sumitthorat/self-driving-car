...
#define TRIG      14            // Trigger pin
#define ECHO      15            // Echo pin for sensor 1
#define ECHO1     18            // Echo pin for sensor 2
#define ECHO2     23            // Echo pin for sensor 3
